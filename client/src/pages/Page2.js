        ...
        <div className="page-2-container">
            <div className="cards-container">
                <div className="card">
                    ...
                    <h2>NOUVEAU CAS</h2>
                    <p>Tout cas qui <strong>n'a jamais été enregistré</strong> dans notre site web</p>
                    <Link to={'/p3'}>Ajouter</Link>
                </div>
                ...
                <div className="card">
                    ...
                    <h2>ANCIEN CAS</h2>
                    <p>Tous les cas qui <strong>sont enregistrés</strong> sur notre site Web</p>
                    <Link to={'/p4'}>Suivant</Link>
                </div>
            </div>
        </div>
    )
